...
9:["$","div",null,{"className":"mx-auto w-full max-w-screen-lg px-4 sm:px-6","children":["$","div",null,{"className":"py-8","children":[["$","div",null,{"className":"text-center space-y-4","children":[["$","h1",null,{"className":"text-4xl font-bold tracking-tight sm:text-5xl","children":"タグ: Frontend"}],["$","p",null,{"className":"text-lg text-muted-foreground max-w-2xl mx-auto","children":"Frontendに関連する記事の一覧です。"}]]}],["$","div",null,{"className":"mt-8","children":[["$","p",null,{"className":"text-gray-600 dark:text-gray-400 mb-6","children":[2,"件の記事が見つかりました"]}],["$","$L17",null,{"posts":[{"id":"nextjs-15-features","slug":"nextjs-15-features","title":"Next.js 15の新機能と実装方法","description":"Next.js 15で追加された新機能とその実装方法について詳しく解説します。App Routerの改善点、React 19対応、TurbopackによるビルドパフォーマンスなHint向上について説明します。","content":"$18","date":"2024-03-15","author":"Developer","category":"Frontend","tags":["Next.js","React","JavaScript","TypeScript","Frontend"],"image":"/images/blog/nextjs-15.png","featured":true,"published":true,"readingTime":{"text":"4 min read","minutes":3.05,"time":183000,"words":610}},{"id":"react-hooks-guide","slug":"react-hooks-guide","title":"React Hooksの実践的な使い方","description":"React Hooksを使った効率的なコンポーネント設計と状態管理の方法について、実用的な例とともに解説します。","content":"$19","date":"2024-03-05","author":"Developer","category":"React","tags":["React","Hooks","JavaScript","Frontend","State Management"],"image":"/images/blog/react-hooks.png","featured":true,"published":true,"readingTime":{"text":"5 min read","minutes":4.955,"time":297300,"words":991}}]}]]}]]}]}]
e:null
12:[["$","meta","0",{"charSet":"utf-8"}],["$","meta","1",{"name":"viewport","content":"width=device-width, initial-scale=1"}]]
d:null
16:{"metadata":[["$","title","0",{"children":"Frontend - タグ | ブログ"}],["$","meta","1",{"name":"description","content":"Frontendタグの記事一覧です。"}],["$","meta","2",{"name":"author","content":"Portfolio"}],["$","meta","3",{"name":"keywords","content":"Next.js,TypeScript,React,Web開発,ポートフォリオ,ブログ"}],["$","link","4",{"rel":"icon","href":"/favicon.ico","type":"image/x-icon","sizes":"16x16"}]],"error":null,"digest":"$undefined"}
