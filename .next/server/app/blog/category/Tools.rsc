...
9:["$","div",null,{"className":"mx-auto w-full max-w-screen-lg px-4 sm:px-6","children":["$","div",null,{"className":"py-8","children":[["$","div",null,{"className":"text-center space-y-4","children":[["$","h1",null,{"className":"text-4xl font-bold tracking-tight sm:text-5xl","children":"カテゴリ: Tools"}],["$","p",null,{"className":"text-lg text-muted-foreground max-w-2xl mx-auto","children":"Toolsに関連する記事の一覧です。"}]]}],["$","div",null,{"className":"mt-8","children":[["$","p",null,{"className":"text-gray-600 dark:text-gray-400 mb-6","children":[1,"件の記事が見つかりました"]}],["$","$L17",null,{"posts":[{"id":"github-workflow","slug":"github-workflow","title":"GitHub ノウハウまとめ","description":"Github ノウハウまとめ","content":"$18","date":"2024-03-15","author":"Developer","category":"Tools","tags":["GitHub","Tutorial"],"image":"/images/blog/github.png","featured":true,"published":true,"readingTime":{"text":"3 min read","minutes":2.645,"time":158700,"words":529}}]}]]}]]}]}]
e:null
12:[["$","meta","0",{"charSet":"utf-8"}],["$","meta","1",{"name":"viewport","content":"width=device-width, initial-scale=1"}]]
d:null
16:{"metadata":[["$","title","0",{"children":"Tools - カテゴリ | ブログ"}],["$","meta","1",{"name":"description","content":"Toolsカテゴリの記事一覧です。"}],["$","meta","2",{"name":"author","content":"Portfolio"}],["$","meta","3",{"name":"keywords","content":"Next.js,TypeScript,React,Web開発,ポートフォリオ,ブログ"}],["$","link","4",{"rel":"icon","href":"/favicon.ico","type":"image/x-icon","sizes":"16x16"}]],"error":null,"digest":"$undefined"}
